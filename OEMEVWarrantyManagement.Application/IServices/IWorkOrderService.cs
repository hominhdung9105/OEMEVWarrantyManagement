...
//        Task<IEnumerable<WorkOrderDto>> GetWorkOrderByTechAsync(Guid techId, PaginationRequest request);
//        Task<IEnumerable<WorkOrderDto>> GetWorkOrderOfTechByTypeAsync(Guid techId, WorkOrderType type, PaginationRequest request);
...
//        Task<IEnumerable<WorkOrderDetailDto>> GetWorkOrdersDetailByTechAsync(PaginationRequest request, string? type = null, string? status = null, DateTime? from = null, DateTime? to = null);
