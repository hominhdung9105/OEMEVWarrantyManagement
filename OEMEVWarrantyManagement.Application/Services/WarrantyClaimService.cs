...
//        public async Task<IEnumerable<WarrantyClaimDto>> GetAllWarrantyClaimAsync(PaginationRequest request)
//        {
//            var entities = await _warrantyClaimRepository.GetAllWarrantyClaimAsync(request);
...
//        public async Task<IEnumerable<WarrantyClaimDto>> GetWarrantyClaimByVinAsync(string vin, PaginationRequest request)
//        {
//            var entities = await _warrantyClaimRepository.GetWarrantyClaimsByVinAsync(vin, request);
...
//        public async Task<IEnumerable<WarrantyClaimDto>> GetWarrantyClaimByVinByOrgIdAsync(string vin, PaginationRequest request)
//        {
//            var staffId = _currentUserService.GetUserId();
//            var entities = await _warrantyClaimRepository.GetWarrantyClaimsByVinAsync(vin, staffId.ToString(), request);
//            if (entities == null || !entities.Any())
//            {
...
//            return _mapper.Map<WarrantyClaimDto>(update);
//        }
//        public async Task<IEnumerable<WarrantyClaimDto>> GetWarrantyClaimsByStatusAndOrgIdAsync(string status, PaginationRequest request)
//        {
//            var orgId = await _currentUserService.GetOrgId();
//            var entities = await _warrantyClaimRepository.GetWarrantyClaimsByStatusAndOrgIdAsync(status, orgId, request);
//            return _mapper.Map<IEnumerable<WarrantyClaimDto>>(entities);
//        }

//        public async Task<IEnumerable<WarrantyClaimDto>> GetWarrantyClaimByStatusAsync(string status, PaginationRequest request)
//        {
//            var entities = await _warrantyClaimRepository.GetWarrantyClaimByStatusAsync(status, request);
//            return _mapper.Map<IEnumerable<WarrantyClaimDto>>(entities);
//        }
...
//            return claimDtos;
//        }
//        public async Task<IEnumerable<ResponseWarrantyClaimDto>> GetWarrantyClaimHavePolicyAndPartsAndOrgByStatus(string status)
//        {
//            var orgId = await _currentUserService.GetOrgId();
//            var claims = await _warrantyClaimRepository.GetWarrantyClaimsByStatusAndOrgIdAsync(status, orgId);
